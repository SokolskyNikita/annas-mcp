...
type BookSearchParams struct {
	...
	Content        string `json:"content,omitempty" mcp:"Optional content filter: book_any, book_fiction, book_nonfiction, magazine, or standards_document. Defaults to book_any"`
...
type ArticleSearchParams struct {
	Query          string `json:"query" mcp:"DOI (for example 10.1038/nature12345) or search keywords"`
	Content        string `json:"content,omitempty" mcp:"Optional content filter. Defaults to journal"`
	Language       string `json:"language,omitempty" mcp:"Optional ISO 639-1 language code, for example en"`
...
type ArticleDownloadParams struct {
	DOI            string `json:"doi" mcp:"DOI of the article to download"`
	TimeoutSeconds int    `json:"timeout_seconds,omitempty" mcp:"Optional HTTP timeout in seconds. Defaults to 1800"`
}
